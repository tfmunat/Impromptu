...
class TestCaseUserController(unittest.TestCase):
    ...
    def signUp(self, dataload, mock_MongoClient):
        ...
        return self.app.post('/signup', data=dataload, content_type="application/json")
...
class TestCaseEventController(unittest.TestCase):
    ...
    def createEvent(self, dataload, mock_MongoClient):
        mock_MongoClient.return_value = self.mock_server
        return self.app.post('/eventadd', data=dataload, content_type= "application/json")
    ...
    def test_searchEventsKeyword(self, mock_MongoClient):
        ...
        with self.context:
            ...
            return_value = searchEventsKeyword(correct[0],correct[1],correct[2],correct[3])
            assert return_value.status_code == 200

            incorrect = [40.8, 100.0, 1, 'Singing']
            return_value = searchEventsKeyword(incorrect[0],incorrect[1],incorrect[2],incorrect[3])
